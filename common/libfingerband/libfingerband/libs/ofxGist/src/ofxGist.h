...
class ofxGist {
  ...
  public:
    ...
    const vector<float>& getMagnitudeSpectrum() {
    ...
    static  vector<string>getFeatureNames(){
        ...
        ofxGist::_featureNames.push_back("GIST_PITCH,");
        ofxGist::_featureNames.push_back("GIST_NOTE,");
        ofxGist::_featureNames.push_back("GIST_ROOT_MEAN_SQUARE,");
        ofxGist::_featureNames.push_back("GIST_PEAK_ENERGY,");
        ofxGist::_featureNames.push_back("GIST_SPECTRAL_CREST,");
        ofxGist::_featureNames.push_back("GIST_ZERO_CROSSING_RATE,");
        ofxGist::_featureNames.push_back("GIST_SPECTRAL_CENTROID,");
        ofxGist::_featureNames.push_back("GIST_SPECTRAL_FLATNESS,");
        ofxGist::_featureNames.push_back("GIST_SPECTRAL_DIFFERENCE,");
        ofxGist::_featureNames.push_back("GIST_SPECTRAL_DIFFERENCE_COMPLEX,");
        ofxGist::_featureNames.push_back("GIST_SPECTRAL_DIFFERENCE_HALFWAY,");
        ofxGist::_featureNames.push_back("GIST_HIGH_FREQUENCY_CONTENT");
...
//        ofLogWarning()<<"ofGist feature "<<n<<" doesn't exist"<<endl;
    ...
    ofxGist(int audioFrameSize, int fs, WindowType windowType):gist(audioFrameSize, fs, windowType) {
        setup();
    };
	...
	void processAudio(const float * input, int bufferSize = 512, int nChannels = 2,int sampleRate = 44100);
